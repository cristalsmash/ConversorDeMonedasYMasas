...
public class Frame extends JFrame {
	...
	public Frame() {
		...
		do {
			Object seleccionPesoOMasa = JOptionPane.showInputDialog(null, "Selecciona una opción de Masas o Monedas: ",				
					"Menu",JOptionPane.PLAIN_MESSAGE,null,
					new Object[] {"Conversor de Monedas","Conversor de Masas"}, "Seleccione un tipo de conversor");
